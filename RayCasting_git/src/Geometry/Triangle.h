...
#include <cassert>
//#include <Geometry/generic_texture.hpp>
//#include <Geometry/TriangleTetxture.h>
...
namespace Geometry
{
	...
	public:
		...
		TriangleMultipleTexture<bool> * m_light_tex;
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		Triangle(Math::Vector3f * a, Math::Vector3f * b, Math::Vector3f * c, Material * material, const Math::Vector3f * normals = nullptr)
			: m_material(material), m_light_tex(nullptr)
		{
			m_vertex[0] = a ;
			m_vertex[1] = b ;
			m_vertex[2] = c ;
		...
		Triangle(Triangle const& other) :
			m_material(other.m_material), m_light_tex(other.m_light_tex == nullptr ? nullptr : new TriangleMultipleTexture<bool>(*other.m_light_tex))
		{
		...
		*/
		...
		/// </summary>
		/// <returns></returns>
		Math::Vector3f randomBarycentric() const
		{
		...
		/// </summary>
		/// <returns></returns>
		Math::Vector3f randomPoint() const
		{
			double r = (double)rand() / RAND_MAX; 
			double s = (double)rand() / RAND_MAX; 
			double a = double(1.0) - sqrt(s);
